...
if [[ $(id -u) -eq 0 ]]; then
	...
	if [[ "$BUILD_TOOL" == "catkin_make" ]]; then
		...
		echo "function catkin_make(){(cd ~/sick_wagen_ws && command catkin_make \$@) && source ~/sick_wagen_ws/devel/setup.bash;}" >> /home/${DEFAULT_USER}/.bash_aliases
		mkdir -p /home/${DEFAULT_USER}/sick_wagen_ws/src \
		&& /bin/bash -c ". /opt/ros/noetic/setup.bash; catkin_init_workspace /home/${DEFAULT_USER}/sick_wagen_ws/src" > /dev/null
		echo 'source /opt/ros/noetic/setup.bash' >> /home/${DEFAULT_USER}/.bashrc
	fi
	# if [[ "$BUILD_TOOL" == "catkin-tools" ]]; then
	mkdir -p /home/${DEFAULT_USER}/sick_wagen_ws/src \
	&& /bin/bash -c "cd /home/${DEFAULT_USER}/sick_wagen_ws;. /opt/ros/noetic/setup.bash; catkin init" > /dev/null
	echo 'source /opt/ros/noetic/setup.bash' >> /home/${DEFAULT_USER}/.bashrc
	...
	if [ -e /ws ]; then
	ln -s /ws /home/${DEFAULT_USER}/sick_wagen_ws/src
	fi
...
echo 'export ROS_3D_MAP=/home/sick/Docker/sick_wagen_ws/maps/3d_fix_down19.pcd' >> /home/${DEFAULT_USER}/.bashrc
echo 'export ROS_WAYPOINT_DIR=/home/sick/Docker/sick_wagen_ws/waypoints' >> /home/${DEFAULT_USER}/.bashrc
echo 'export ROS_MASTER_PC_IP=192.168.0.101' >> /home/${DEFAULT_USER}/.bashrc
echo 'export SICK_WAGEN_XACRO=sick_wagen.xacro' >> /home/${DEFAULT_USER}/.bashrc
echo 'export ROS_WAYPOINT_FILE=/home/sick/Docker/sick_wagen_ws/waypoints/20231118_214223.csv' >> /home/${DEFAULT_USER}/.bashrc
